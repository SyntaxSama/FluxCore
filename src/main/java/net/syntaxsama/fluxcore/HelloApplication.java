...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        WindowContent player = (WindowContent) newStage.getScene();
        player.addSprite("/Users/syntaxsama/IdeaProjects/FluxCore/src/main/resources/smile.png", 100, 100, 100, 100);

        WindowControls controls = new WindowControls(player, player.getSprite(), 5.0);
